defmodule ConduitWeb.FavoriteArticleControllerTest do
    ...
    test "should be favorited and return article", %{conn: conn, user: user} do
      conn =
        post(
          ...
          Routes.favorite_article_path(conn, :create, "how-to-train-your-dragon")
        )
  ...
  describe "unfavorite article" do
    ...
    @tag :web
    test "should be unfavorite and return article", %{conn: conn, user: user} do
      conn =
        delete(
          authenticated_conn(conn, user),
          Routes.favorite_article_path(conn, :delete, "how-to-train-your-dragon")
        )
